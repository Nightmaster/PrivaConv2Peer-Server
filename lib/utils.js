...
// /!\ 'setItemToLS' & 'setItemToSS' nécessitent une librairie JSON. JSON3 est recommandé, et disponible ici:
...
* 
* @param name {String} || {Array} : a string or an array of string which contains the Local Storage's name(s) to get
* @returns {String} || {Array} a string or an array of string containing the string stored in the Local Storage. If the item <code>name</code> does not exists in the Local Storage, the result will be <code>null</code>.
**/
...
*
* @see <a
*      href='http://www.w3.org/TR/webstorage/#the-localstorage-attribute'>W3C doc for Local Storage</a>
*
* @param name {String} || {Array} : a string or an array of string which contains the Local Storage's name(s) to set
...
* @see <a href='http://www.w3.org/TR/webstorage/#the-localstorage-attribute'>W3C doc for Local Storage</a>
*
* @param name {String} || {Array} : a string or an array of string which contains the Local Storage's name(s) to remove
**/
...
*
* @param name {String} || {Array} : a string or an array of string which contains the Session Storage's name(s) to get 
* @returns {String} || {Array} a string or an array of string containing the string stored in the Session Storage. If the item <code>name</code> does not exists in the Local Storage, the result will be <code>null</code>.
**/
...
* @see <a href='http://www.w3.org/TR/webstorage/#the-sessionstorage-attribute'>W3C doc for Session Storage</a>
*
* @param name {String} || {Array} : a string or an array of string which contains the Session Storage's name(s) to set
* @param val {String} : the value to put in its element.
**/
...
* @see <a href='http://www.w3.org/TR/webstorage/#the-sessionstorage-attribute'>W3C doc for Session Storage</a>
*
* @param name {String} || {Array} : a string or an array of string which contains the Session Storage's name(s) to remove
**/
...
function stringifyDateFr(date)
{
	if (null === date || undefined === date)
	{
		...
		throw new TypeError('The argument must be a Date, or set to: empty or null');
}

/**
* The function used to visit each node of a DOM organized document (like XML and/or HTML).
*
* @param parentNode {Node}: the "master" node from which you start the children's visit
**/
...
if (isDefined(require) && null !== module.exports && undefined !== module.exports)
